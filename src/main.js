        ...
        themes: {
          light: {
            ...
            colors: {
              ...
              ninetynine: colors. ,
              onehundred: colors. ,
              onehundredone: colors. ,
              onehundredtwo: colors. ,
              onehundredthree: colors. ,
              onehundredfour: colors. ,
              onehundredfive: colors. ,
              onehundredsix: colors. ,
              onehundredseven:colors.  ,
              onehundredeight:colors.  ,
              onehundrednine: colors. ,
              onehundredten: colors. ,
